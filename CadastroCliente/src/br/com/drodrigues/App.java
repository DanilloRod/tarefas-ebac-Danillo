 ...
 * @author danil
 */
package br.com.drodrigues;

import br.com.drodrigues.dao.ClienteMapDAO;
import br.com.drodrigues.dao.IClienteDAO;
import br.com.drodrigues.domain.Cliente;
import br.com.drodrigues.dao.ClienteSetDAO;
import javax.swing.*;
        ...
        while (isOpcaoValida(opcao)) {
            if (isOpcaoSair(opcao)) {
                ...
                String dados = JOptionPane.showInputDialog(null,
                        "Digite os dados do cliente separados por vírgula, conforme exemplo: Nome, CPF, Tel, End, Numero, Estado, Cidade",
                        "Cadastro", JOptionPane.INFORMATION_MESSAGE);
                cadastrar(dados);
